...
Полный список всех изменений и дополнений на 21.06.2003.
...
[fix] По фейнутому спаю не стреляет сентри.
      ...
      до тех пор, рока в ней не кончались патроны.
...
[new] Максимально количество армора сокращено до 75 единиц.
      ...
      Пока сделали 75. Что бы, после прыжка на гранате, оставалось порядка 10 армора.
      Возможно, данную цифру придется уменьшить до 70 или даже 60. Тестируем в игре...
...
[fix] Поправлен баг сентри с непопаданием шеллами
      ...
      Теперь этот баг убран (взято из нынешней версии).
...
[opt] Возможность выбора между различными алгоритмами работы сентри.
      ...
      "localinfo sg fix" - поиск цели новый, выстрел шеллами лиговский.
      Любое другое - поиск цели из 2.8, выстрел шеллами лиговский.
...
[opt] Возможность подбирать из рюкзаков убитых не только патроны.
      ...
      которым играет, подобравший рюкзак, игрок. Например, солдат не сможет взять напалм.
