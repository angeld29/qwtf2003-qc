...
Полный список всех изменений и дополнений на 04.07.2003.
...
[add] Сканнер может показывать более чем на одного игрока.
...
[opt] Окончательно исправлен баг сентри с непопаданием шеллами при стрельбе.
      Включается на сервере "localinfo sg fix" или "localinfo sg new".
      // Стандартный лиговский фикс не исправлял баг полностью. Данный фикс делает это.
