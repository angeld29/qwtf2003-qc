...
Полный список всех изменений и дополнений на 03.03.2004.
...
[opt] Новый эффект от flash гранаты: В течении 2 секунд экран монитора полностью белый.
      В течении 2 секунд не поступает информация запрашиваемая по команде "id"
      В течении 2 секунд не поступает визуальная информация об entity (данная функция
...
[fix] Под водой нельзя ничего поджечь.
...
[fix] Пофикшено проваливание построек сквозь пол (требуется сервер qw262 от 28.02.04).
      // Древнейший баг из-за которого пушки и диспы могли проваливаться через цельный пол.
