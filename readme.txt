...
Полный список всех изменений и дополнений на 25.09.2003.
...
[opt] Возможность включения нового эффекта от flash гранаты:
      ...
      В течении 2 секунд не поступает визуальная информация об entity, в том числе
      и запрашиваемая по команде "id" (данная функция работает только под qwsv262).
